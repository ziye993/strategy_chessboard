...
import { ILoginData } from '@/type/api.type';
import { IAuthProvide, IAuthStatus } from '@/type/auth.context.type';
...
// 创建认证上下文
export const AuthContext = createContext<IAuthProvide | undefined>(undefined);

// 认证提供者组件
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  const [state, setState] = useState<IAuthStatus>({
    user: null,
    token: null,
